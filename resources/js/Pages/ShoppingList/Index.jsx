...
export default function Index({ shops }) {
    ...
    function markAsEdit(id) {
        window.location.href = `/shops/${id}/edit`;
    }

    function deleteRow(id) {
        Swal.fire({
            title: "Biztos, hogy törli a kiválasztott bevásárló listát?",
            icon: "warning",
    ...
    function sendData(e) {
        ...
        router.post("/shoppinglist", dataToSend);
        router.on("success", () =>
            Swal.fire({
                title: "Sikeres",
                icon: "success",
        ...
        <Layout>
            ...
            {shop.length !== 0 ? (
                        ...
                        <div key={f.id}>
                            ...
                            >
                                <p
                                    ...
                                    onClick={() => {
                                        window.location.href = `/shops/${f.id}`;
                                    }}
                                >
                                    {f.name}
                                </p>
                ...
                <p className="text-red-500 font-bold">
                    Nincsenek bevásárló listák, adj hozzá valamit!
                </p>
            )}
